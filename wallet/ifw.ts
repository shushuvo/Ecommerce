//ifwallet route should be used when user clicks on use wallet point 
//ifwalletdelt route should be used when a user clicks on don't use wallet point 
